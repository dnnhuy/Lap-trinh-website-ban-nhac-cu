    ...
    public partial class GuiDonHang : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Page.PreviousPage != null)
            {
                ...
                lblThongBao.Text += "Quý khách vừa đặt thành công các sản phẩm nhạc cụ của shop. ";
                ...
                lblThongBao.Text += "Cảm ơn quý khách đã tin tưởng, chọn mua các nhạc cụ và sản phẩm âm nhạc tại Việt Thương.<br />";
